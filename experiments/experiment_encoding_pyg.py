...
from src.filters.filter_encodeedgefeatures_pyg import FilterEncodeEdgeFeatures
from src.filters.filter_encodenodefeatures_pyg import FilterEncodeNodeFeatures
from src.filters.filter_encodegraphconnections_pyg import FilterEncodeGraphConnections
...
from experiments import ENCODING_PATH_PYG, L_KEEP_EDGE, L_KEEP_NODE, NORMALIZATION_PATH
...
class ExperimentEncoding():
    ...
    def __init__(self, dataset='merged'):
        ...
        self.d_conf = yaml_to_dict('config/conf_encodingpip_pyg.yml')
        ...
        self.d_conf['SinkDictFlat']['parms']['output_path'] = ENCODING_PATH_PYG.format(dataset)
